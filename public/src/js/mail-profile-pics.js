...
function installStyles() {
  ...
  style.textContent = `
    ...
    @media(max-width:700px){
      html body #dni-mail-panel .dni-mail-message{min-height:0!important}
      html body #dni-mail-panel .dni-mail-message.has-profile-pic{display:grid!important;grid-template-columns:32px minmax(0,1fr)!important;grid-template-rows:auto auto auto!important;column-gap:10px!important;row-gap:0!important;padding:10px 11px!important;text-align:left!important}
      ...
      html body #dni-mail-panel .dni-mail-message.has-profile-pic>.dni-mail-message-top{grid-row:1!important;align-items:center!important;gap:7px!important}
      html body #dni-mail-panel .dni-mail-message.has-profile-pic>.dni-mail-message-subject{grid-row:2!important;margin-top:3px!important}
      html body #dni-mail-panel .dni-mail-message.has-profile-pic>.dni-mail-message-meta{grid-row:3!important;margin-top:5px!important}
      html body #dni-mail-panel .dni-mail-message-preview{display:none!important}
      html body #dni-mail-panel .dni-mail-message-subject{display:block!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important;-webkit-line-clamp:unset!important;font-size:12px!important;line-height:1.3!important}
      html body #dni-mail-panel .dni-mail-message-sender{min-width:0!important;overflow:hidden!important;text-overflow:ellipsis!important;white-space:nowrap!important;font-size:10px!important;line-height:1.25!important}
      html body #dni-mail-panel .dni-mail-message-date{flex:0 0 auto!important;white-space:nowrap!important;font-size:8px!important;line-height:1.25!important}
      html body #dni-mail-panel .dni-mail-message-meta{display:flex!important;flex-wrap:nowrap!important;align-items:center!important;gap:5px!important;overflow-x:auto!important;overflow-y:hidden!important;padding-bottom:1px!important;scrollbar-width:none!important;-webkit-overflow-scrolling:touch!important}
      html body #dni-mail-panel .dni-mail-message-meta::-webkit-scrollbar{display:none!important}
      html body #dni-mail-panel .dni-mail-message-meta>span{flex:0 0 auto!important;white-space:nowrap!important;font-size:7px!important;line-height:1!important;padding:3px 4px!important}
