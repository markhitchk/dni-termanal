export const DNI_SECTORS_SEED = {
  ...
  assets: [
    ...
    { id: '1st-fleet', sectorId: 'sol', type: 'fleet', name: '1ST IMPERIAL FLEET', shortName: '1ST FLEET', status: 'OPERATIONAL', personnel: 0, vessels: 8, commander: 'ADM. CAELUS', location: 'ORBIT — SOL PRIME', homeBaseId: 'bastion-prime', x: 76, y: 46 },
    ...
    { id: '4th-fleet', sectorId: 'acheron', type: 'fleet', name: '4TH IMPERIAL FLEET', shortName: '4TH FLEET', status: 'OPERATIONAL', personnel: 0, vessels: 9, commander: 'ADM. VORAN', location: 'ORBIT — ACHERON PRIME', homeBaseId: 'cerberus', x: 78, y: 48 },
    { id: '7th-support', sectorId: 'acheron', type: 'fleet', name: '7TH SUPPORT GROUP', status: 'OPERATIONAL', personnel: 0, vessels: 4, commander: 'CDR. TAL', location: 'CERBERUS APPROACH', homeBaseId: 'cerberus', x: 72, y: 75 },
    ...
    { id: '5th-fleet', sectorId: 'vega', type: 'fleet', name: '5TH IMPERIAL FLEET', shortName: '5TH FLEET', status: 'OPERATIONAL', personnel: 0, vessels: 6, commander: 'ADM. RHEA', location: 'VEGA PRIME', homeBaseId: 'vega-bastion', x: 76, y: 48 },
    ...
    { id: '9th-fleet', sectorId: 'nyx', type: 'fleet', name: '9TH IMPERIAL FLEET', shortName: '9TH FLEET', status: 'ALERT', personnel: 0, vessels: 5, commander: 'CDR. KEST', location: 'NYX PERIMETER', x: 75, y: 50 },
