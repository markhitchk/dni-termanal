...
<head>
  ...
  <style>
    body{margin:0;background:#000;color:#e7e7e7}.preview-shell{width:min(1120px,calc(100% - 28px));margin:24px auto 48px}.preview-banner{display:flex;align-items:center;justify-content:space-between;gap:14px;flex-wrap:wrap;padding:13px 15px;margin-bottom:16px;border:1px solid rgba(255,196,0,.58);background:rgba(58,40,0,.38)}.preview-banner strong{letter-spacing:.08em}.preview-banner small{display:block;margin-top:5px;opacity:.78}.preview-grid{display:grid;grid-template-columns:1.25fr .9fr;gap:14px}.preview-card,.preview-section{border:1px solid rgba(125,226,255,.24);background:rgba(5,17,25,.68);padding:16px}.preview-avatar{width:76px;height:76px;border-radius:50%;object-fit:cover;margin:8px 0}.preview-values{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:9px;margin-top:14px}.preview-value{padding:10px;border:1px solid rgba(125,226,255,.16);background:rgba(0,0,0,.22)}.preview-value span{display:block;font-size:.7rem;opacity:.66}.preview-value b{display:block;margin-top:4px}.preview-chips{display:flex;flex-wrap:wrap;gap:7px;margin-top:12px}.preview-chip{padding:7px 9px;border:1px solid rgba(125,226,255,.2);font-size:.78rem}.preview-chip.restricted{opacity:.6}.preview-links{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;margin-top:12px}.preview-link{display:flex;align-items:center;gap:12px;min-height:76px;padding:12px 14px;border:1px solid rgba(125,226,255,.36);background:linear-gradient(180deg,rgba(7,24,35,.88),rgba(4,14,22,.82));color:inherit;text-decoration:none;box-shadow:inset 0 0 0 1px rgba(125,226,255,.04)}.preview-link:active,.preview-link:focus-visible{border-color:rgba(125,226,255,.82);background:linear-gradient(180deg,rgba(9,34,49,.96),rgba(5,20,30,.92));outline:none}.preview-icon{width:48px;height:48px;display:grid;place-items:center;overflow:hidden;flex:0 0 48px;border:1px solid rgba(125,226,255,.28);background:rgba(0,0,0,.32)}.preview-icon svg{width:30px;height:30px}.preview-icon img{width:100%;height:100%;object-fit:contain;padding:3px;box-sizing:border-box}.preview-link-copy{min-width:0;display:grid;gap:3px;flex:1 1 auto}.preview-link-copy strong{font-size:.96rem}.preview-link-copy span{display:block;margin-top:3px;font-size:.76rem;opacity:.72}.preview-link-action{flex:0 0 auto;min-height:40px;display:inline-flex;align-items:center;justify-content:center;gap:6px;padding:0 12px;border:1px solid rgba(125,226,255,.52);background:rgba(0,18,28,.72);font:700 .7rem/1 system-ui,sans-serif;letter-spacing:.08em;white-space:nowrap}.preview-section{margin-top:14px}.preview-actions{display:flex;gap:10px;flex-wrap:wrap}.preview-action{display:inline-flex;padding:10px 12px;border:1px solid rgba(125,226,255,.42);color:inherit;text-decoration:none;background:rgba(0,0,0,.24)}@media(max-width:760px){.preview-shell{width:min(100% - 18px,1120px);margin-top:10px}.preview-grid,.preview-links,.preview-values{grid-template-columns:1fr}.preview-card,.preview-section{padding:13px}.preview-link{flex-wrap:wrap;padding:12px}.preview-link-action{flex:1 0 100%;width:100%;margin-top:2px}}
  </style>
</head>
<body>
<main class="preview-shell">
  <div class="preview-banner">
    ...
    <div class="preview-actions"><a class="preview-action" href="/dashboard">EXIT PREVIEW</a></div>
  </div>
  ...
  <section class="preview-section">
    ...
    <div class="preview-links">
      <a class="preview-link" href="https://discord.gg/dreadnoughtimperium" target="_blank" rel="noopener noreferrer external"><span class="preview-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M19.54 5.34A16.8 16.8 0 0 0 15.44 4l-.5 1.03a15.4 15.4 0 0 0-5.87 0L8.55 4a16.9 16.9 0 0 0-4.1 1.35C1.86 9.16 1.15 12.86 1.5 16.5a16.8 16.8 0 0 0 5.03 2.54l1.22-1.67a10.8 10.8 0 0 1-1.93-.92l.47-.36c3.72 1.7 7.77 1.7 11.45 0l.47.36c-.62.36-1.27.67-1.94.92l1.22 1.67a16.8 16.8 0 0 0 5.03-2.54c.42-4.22-.72-7.88-2.98-11.16Z"/></svg></span><span class="preview-link-copy"><strong>Discord</strong><span>Join the Dreadnought Imperium Discord</span></span><span class="preview-link-action">OPEN DISCORD ↗</span></a>
      <a class="preview-link" href="https://robertsspaceindustries.com/en/orgs/DNI" target="_blank" rel="noopener noreferrer external"><span class="preview-icon"><img src="https://robertsspaceindustries.com/media/ym5kkd52hhrclr/logo/DNI-Logo.png" alt="Dreadnought Imperium RSI logo" referrerpolicy="no-referrer"></span><span class="preview-link-copy"><strong>Roberts Space Industries</strong><span>Dreadnought Imperium organization page</span></span><span class="preview-link-action">OPEN RSI ↗</span></a>
    </div>
  </section>
