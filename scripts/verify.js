...
const required = [
  ...
  'server/php/dni.php','server/php/api-runtime.php','public/api/index.php','public/auth/index.php',
  'public/src/js/dashboard.js','public/src/js/services.js','public/src/js/comms-provider.js',
  'public/src/js/sectors-api.js','public/src/js/sectors-admin.js','public/src/js/routing.js','public/src/css/modules.css',
  'deploy/ovhcloud/bootstrap-vps.sh','deploy/ovhcloud/configure-httpd-vhost.php','public/deploy.php'
];
...
markers('public/src/js/dashboard.js', ['/api/dni/dashboard','Documentation Browser','CLEARANCE MATRIX','SIGN IN WITH DISCORD']);
markers('public/src/js/services.js', ['/api/dni/services/types','/api/dni/services/requests','CLAIM','START WORK','COMPLETE','OPEN → CLAIMED → IN PROGRESS → COMPLETED']);
...
markers('public/src/js/routing.js', ['/terminal','/dashboard','/services','/communication','/sectors','popstate']);
...
for (const file of ['public/src/js/script.js','public/src/js/comms-provider.js','public/src/js/dashboard.js','public/src/js/services.js','public/src/js/sectors-api.js','public/src/js/sectors-admin.js','public/index.html','public/src/html/index.html']) {
...
console.log('DNI MariaDB + Discord + Dashboard + Services + Sectors + server-side Star Comms verification passed.');
