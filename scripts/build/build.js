...
fs.appendFileSync(
  ...
  `void import('./mail-controls.js?v=${cacheKey}').then(() => import('./mail-ux.js?v=${cacheKey}')).then(() => import('./mail-organizer.js?v=${cacheKey}')).then(() => import('./mail-compose-v2.js?v=${cacheKey}')).then(() => import('./mail-realtime.js?v=${cacheKey}')).then(() => import('./mail-priority-live.js?v=${cacheKey}')).catch(error => console.error('DNI Mail controls/gate/organizer/compose/realtime UX failed', error));\n` +
