...
const pairs = [
  ...
  ['public/src/js/session-expiry.js', 'public/dist/session-expiry.js'],
  ['public/src/js/citizen-access.js', 'public/dist/citizen-access.js'],
...
fs.appendFileSync(
  ...
  `void import('./mail-controls.js?v=${cacheKey}').then(() => import('./mail-ux.js?v=${cacheKey}')).then(() => import('./mail-organizer.js?v=${cacheKey}')).then(() => import('./mail-compose-v2.js?v=${cacheKey}')).then(() => import('./mail-recipient-dropdown.js?v=${cacheKey}')).then(() => import('./mail-realtime.js?v=${cacheKey}')).then(() => import('./mail-priority-live.js?v=${cacheKey}')).catch(error => console.error('DNI Mail controls/gate/organizer/compose/recipient-dropdown/realtime UX failed', error));\n` +
...
const versionedAssets = [
  ...
  'dist/mobile-tablet.css', 'dist/modules.css', 'dist/polish.css', 'dist/documents-workflow.css', 'dist/bounty.css', 'dist/bounty-desktop.css', 'dist/bounty-tablet.css', 'dist/bounty-mobile.css', 'dist/desktop-source.css', 'src/js/page-loader.js', 'src/js/core/unified-contract-view.js'
];
