...
function update_vhost_block(
    ...
    $managed = "\n    {$markerStart}\n"
        ...
        . "            # Curated public emblem PNGs are also served directly from public/logos/emblems/.\n"
        . "            RewriteCond %{HTTP_HOST} ^{$cdnHostPattern}(?::[0-9]+)?$ [NC]\n"
        . "            RewriteCond %{REQUEST_URI} ^/logos/emblems/(?:army|engineering|government|isb|logistics|medical|navy)/[A-Za-z0-9._-]+\\.png$ [NC]\n"
        . "            RewriteRule ^ - [L]\n"
        . "            RewriteCond %{HTTP_HOST} ^{$cdnHostPattern}(?::[0-9]+)?$ [NC]\n"
        ...
        . "            # This keeps session/state handling independent from browser JavaScript and cached callback assets.\n"
        ...
        . "            RewriteRule ^(?:terminal|dashboard|ranks|docs|documents|services(?:/dispatch)?|communication|sectors|mail|bounty|bountyboard|admin|operations)/?$ /index.php [QSA,L]\n"
        . "            RewriteRule ^bounty/[A-Za-z0-9]{6}/?$ /index.php [QSA,L]\n"
        . "\n"
        ...
        . "        </LocationMatch>\n"
        . "        <LocationMatch \"^/logos/emblems/(?:army|engineering|government|isb|logistics|medical|navy)/[A-Za-z0-9._-]+\\.png$\">\n"
        . "            Header always set X-Content-Type-Options \"nosniff\"\n"
        . "            Header always set Cross-Origin-Resource-Policy \"cross-origin\"\n"
        . "            Header always set Cache-Control \"public, max-age=31536000, immutable\"\n"
        . "        </LocationMatch>\n"
